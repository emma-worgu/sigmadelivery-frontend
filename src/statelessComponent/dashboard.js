      ...
      <div className='gen-body'>
        <div className='gen-hd-div'>
          ...
          <div className='gen-hd-bt'>
            <button className='gen-bt' onClick={onSubmit}><b>Edit Tracking Number</b></button>
          </div>
        </div>
        <div className='gen-div'>
          ...
          <div className='gen-in-div'>
            ...
            <input type='text' className='gen-in' value={props.receiverName} onChange={props.onRecieverName} />
          </div>
          <div className='gen-in-div'>
          ...
          <div className='gen-bt-div'>
            <button className='gen-bt' onClick={props.onSubmit}><b>{props.message.loading ? 'Generating' : 'Generate'}</b></button>
          </div>
